...
init: function () {
    ...
    KTC = KTC_contract.at('0xF4EfDF3ae0C328425EF402741f36A381eB087ac7');
},
...
emission: function (address) {
    KTC.emission(address, (error, result) => {
	// TOOD: Handle
    })
}
}
